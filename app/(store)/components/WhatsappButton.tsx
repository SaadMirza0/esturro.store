...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[9999] flex flex-col items-end gap-4">
      ...
      <motion.a
        href={`https://wa.me/923010544620?text=${encodeURIComponent(`I am interested in buying the Product `)}`}
      ...
      <motion.a
        href={`https://wa.me/923010544620?text=${encodeURIComponent(`Hi! from Esturro I need help !!! `)}`}
        target="_blank"
        rel="noopener noreferrer"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
