 ...
 const socialLinks = [
  {
    ...
    icon: (
      <svg width="44" height="44" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <defs>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 448 512" width="44" height="44" fill="#25D366" xmlns="http://w3.org">
  ...
  },
  {
    ...
    icon: (
      <svg width="44" height="44" viewBox="0 0 24 24" fill="#1877F2" stroke="none">
